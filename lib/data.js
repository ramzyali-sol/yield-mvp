...
export const VENUES = [
  ...
  { name:"Hylo",              logo:"Hy", color:"#4ADE80", category:"vault",      type:"Leveraged SOL Vault",    stableApy:null,  solApy:14.00, tvl:45e6,   audits:["Sec3"],                      oss:false, risk:"MEDIUM", note:"xSOL: leveraged SOL with auto-managed borrow loops. SOL-denominated only.", flag:"⚠ Leveraged — SOL directional risk applies", url:"https://hylo.fi" },

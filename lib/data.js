...
export const VENUES = [
  ...
  { name:"Loopscale",           logo:"L",  logoUrl:venueFavicon("loopscale.com"),      color:"#A78BFA", category:"lending",    type:"Fixed-Rate Order Book",  stableApy:null, solApy:null, tvl:null, audits:["Halborn"],                   oss:false, risk:"MEDIUM", noImpact:true, note:"Fixed-rate fixed-term order book. No rate volatility. Oracle hack Apr 2025 — funds recovered.", flag:"⚠ Prior exploit — model upgraded post-incident", url:"https://loopscale.com" },
  { name:"Drift Vaults",        logo:"D",  logoUrl:venueFavicon("app.drift.trade"),    color:"#FF6B35", category:"vault",      type:"Earn Vault",             stableApy:null, solApy:null, tvl:null, audits:["OtterSec","Trail of Bits"],  oss:true,  risk:"LOW",    noImpact:true, note:"Passive vault earning from Drift insurance fund + lending. Stable rate profile.", url:"https://app.drift.trade/earn" },
